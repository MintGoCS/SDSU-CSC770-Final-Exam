...
class TaxTest(unittest.TestCase):
    ...
    def test_different_incomes(self):
        ...
        test_cases = [
            ...
            (25000, 2, 25000 * 0.06 + 25000 * 0.065),

            # Case Group 2
            # Income range: 25,001 <= income <= 55,000
            (25001, 0, 25001 * 0.15 + 25001 * 0.065),
            (40000, 1, 40000 * 0.12 + 40000 * 0.065),
            (55000, 2, 55000 * 0.11 + 55000 * 0.065),

            # Case Group 3
            # Income range: 55,001 <= income <= 105,000
            (55001, 0, 55001 * 0.25 + 55001 * 0.065),
            (80000, 1, 80000 * 0.23 + 80000 * 0.065),
            (105000, 2, 105000 * 0.2 + 105000 * 0.065),

            # Case Group 4
            # Income range: 105,001 <= income <= 205,000
            (105001, 0, 105001 * 0.27 + 105001 * 0.065),
            (150000, 1, 150000 * 0.25 + 150000 * 0.065),
            (205000, 3, 205000 * 0.30 + 205000 * 0.065),

            # Case Group 5
            # Income range: 205,001 <= income <= 255,000
            (205001, 0, 205001 * 0.30 + 205001 * 0.065),
            (220000, 1, 220000 * 0.28 + 220000 * 0.065),
            (255000, 3, 255000 * 0.30 + 255000 * 0.065),

            # Case Group 6
            # Income range: 255,001 <= income <= 405,000
            (255001, 0, 255001 * 0.40 + 255001 * 0.065),
            (350000, 1, 350000 * 0.36 + 350000 * 0.065),
            (350000, 3, 350000 * 0.30 + 350000 * 0.065),

            # Case Group 7
            # Income range: income >= 405,001
            (800000, 0, 800000 * 0.5 + 800000 * 0.065),
